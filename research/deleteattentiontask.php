...
$success = 0;
$sql = 'update task set leader_status = 0, attention_note="",attention_date="",show_attn_team=0,attention_modify_date="",attention_status=0 where id=:projectid';
...
if($q)
{
    ...
    $q = $con->select_query($sql,array(':id'=>$_POST['projectid'],':type'=>TASK_TYPE));
    foreach($q as $r)
    {
        $aid = $r['id'];
    }
